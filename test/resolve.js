...
test(`should resolve relative to 'root' option (sync)`, checkFixture, 'resolve-root', {
    root: 'test/fixtures',
    sync: true,
    path: null,
})
...
test(`should resolve relative to 'path' which resolved with cwd`, checkFixture, 'resolve-path-cwd', {
    path: 'test/fixtures/imports',
})

test(`should resolve relative to 'path' which resolved with 'root'`, checkFixture, 'resolve-path-root', {
    root: 'test/fixtures',
    path: 'imports',
})
